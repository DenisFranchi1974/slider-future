...
const IconControlsInnerHover = ({
  ...
  const isAnimationNone = iconDiv.animationHover === " ";
  const showColorOptionsPanel = [
    "hover-effect-3-icon-inner-",
    "hover-effect-3-icon-inner",
    "hover-effect-4-icon-inner",
    "hover-light-effect-icon-inner",
  ].includes(iconDiv.animationHover);
  const showTranslateRangeControl = [
    "hover-effect-2-icon-inner", // Translate Y
    "hover-effect-5-icon-inner", // Translate X
  ].includes(iconDiv.animationHover);
    ...
    <div className="custom-block-added">
      ...
      <div className="content-section-panel" style={{ padding: "0" }}>
        <div className="custom-select color">
          <ColorOptionsPanel
            colorNormal={iconDiv.textColorHover}
            setColorNormal={(color) =>
              updateSlideTextColorHover(slide.id, elementIndex,iconIndex, color)
            }
        ...
        <div className="custom-select select-control-label-right">
          <SelectControl
            ...
            onChange={(newBorderStyle) =>
              updateBorderStyleHover(slide.id, elementIndex,iconIndex, newBorderStyle)
            }
          />
        </div>
          ...
          <>
            ...
            <div className="custom-select">
                  <RangeControl
                    ...
                    value={iconDiv.backgroundBorderSizeHover}
                    onChange={(newSize) =>
        ...
        <div className="custom-select">
          <RangeControl
            ...
            value={iconDiv.opacityHover}
            onChange={(opacity) =>
              updateOpacityHover(slide.id, elementIndex,iconIndex, opacity)
            }
            min={0.1}
            max={1}
            step={0.1}
        ...
        <div className="custom-select">
          <RangeControl
            ...
            value={iconDiv.rotateHover}
            onChange={(rotate) =>
              updateRotateHover(slide.id, elementIndex,iconIndex, rotate)
            }
            min={0}
            max={360}
            step={1}
        ...
        <div className="custom-select select-control-label-right">
          <SelectControl
            ...
            options={[
              ...
              { label: "Shadow", value: "hover-effect-3-icon-inner-" },
              { label: "Shadow Two", value: "hover-effect-3-icon-inner" },
              { label: "Shadow Three", value: "hover-effect-4-icon-inner" },
              { label: "Filter", value: "hover-effect-6-icon-inner" },
            ]}
            onChange={(animation) =>
              updateTextAnimationHover(slide.id, elementIndex,iconIndex, animation)
            }
          />
        </div>
        {!isAnimationNone && (
          <>
            <div className="custom-select">
              <RangeControl
                ...
                value={iconDiv.durationEffectHover}
            ...
            {showColorOptionsPanel && (
              <div className="custom-select color">
                <ColorOptionsPanel
                  colorNormal={iconDiv.effectHoverColorHover}
                  setColorNormal={(color) =>
                    updateSlideEffectColorHover(slide.id, elementIndex,iconIndex, color)
                  }
            ...
            {showTranslateRangeControl && (
              <div className="custom-select">
                <RangeControl
                  ...
                  value={iconDiv.translateEffectHover}
                  onChange={(newEffect) =>
...
export default IconControlsInnerHover;
