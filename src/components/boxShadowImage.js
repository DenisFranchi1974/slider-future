...
const BoxShadowControlImage = ({ 
  ...
  // Color Shadow
  const updateColorShadowImage = (slideId, index, value) => {
        ...
        ? {
            ...
            elements: slide.elements.map((element, i) =>
              element.type === "image" && i === index
                ? { ...element, colorShadowImage: value }
                : element
            ),
          }
        : slide
  ...
  // Box ShadowX 
  const updateBoxShadowXImage = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
  ...
  // Box ShadowY 
  const updateBoxShadowYImage = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
  ...
  // Box Shadow Blur
  const updateBoxShadowBlurImage = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
            elements: slide.elements.map((element, i) =>
              element.type === "image" && i === index
                ? { ...element, boxShadowBlurImage: value }
                : element
            ),
          }
        : slide
  ...
  // Box Shadow Spread
  const updateBoxShadowSpreadImage = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
            elements: slide.elements.map((element, i) =>
              element.type === "image" && i === index
                ? { ...element, boxShadowSpreadImage: value }
                : element
            ),
          }
        : slide
  ...
  return (
        ...
        <div className="content-section-panel" style={{ padding: "0" }}>
          <div className="custom-select color">
              <ColorOptionsPanel
                colorNormal={element.colorShadowImage}
                setColorNormal={(value) =>
                    updateColorShadowImage(slide.id, elementIndex, value)
                }
            ...
            <div className="custom-select">
                <RangeControl
                    ...
                    value={element.boxShadowXImage}
                    onChange={(value) =>
                        updateBoxShadowXImage(slide.id, elementIndex, value)
                    }
                    min={-100}
                    max={100}
                    step={1}
            ...
            <div className="custom-select">
                ...
                value={element.boxShadowYImage}
                onChange={(value) =>
                    updateBoxShadowYImage(slide.id, elementIndex, value)
                }
                min={-100}
                max={100}
                step={1}
           ...
           <div className="custom-select">
                ...
                value={element.boxShadowBlurImage}
                onChange={(value) =>
                    updateBoxShadowBlurImage(slide.id, elementIndex, value)
                }
                min={0}
                max={100}
                step={1}
                ...
                value={element.boxShadowSpreadImage}
                onChange={(value) =>
                    updateBoxShadowSpreadImage(slide.id, elementIndex, value)
                }
                min={-100}
                max={100}
                step={1}
...
export default BoxShadowControlImage;
