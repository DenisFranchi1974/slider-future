...
const ButtonControlsBlock = ({
  ...
  const [playState, setPlayState] = useState(buttonDiv.playState || "");
  ...
  const removeSlideButtonBlock  = (slideId, divIndex, innerIndex) => {
    ...
    // Update button
    const updateSlideButton = (slideId, divIndex, buttonIndex, newButton) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
...
const removeSlideButtonIcon = (slideId, divIndex, buttonIndex) => {
  ...
  // Update button align
  const updateButtonAlign = (slideId, divIndex, buttonIndex, align) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
              ...
              element.type === "div" && i === divIndex
                ? {
                    ...
                    innerElements: element.innerElements.map(
                      (innerElement, eIndex) =>
                        eIndex === buttonIndex && innerElement.type === "button"
                          ? { ...innerElement, buttonAlign: align }
                          : innerElement
                    ),
                  }
                : element
...
// Update button color
const updateSlideButtonColor = (slideId, divIndex, buttonIndex, color) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === buttonIndex && innerElement.type === "button"
                        ? { ...innerElement, buttonColor: color }
                        : innerElement
                  ),
                }
              : element
...
const updateSlideButtonBackgroundColor = (slideId, divIndex, innerIndex, color) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, buttonBackgroundColor: color }
                        : innerElement
                  ),
                }
              : element
...
// Update Font Family
const updateButtonFamily = (slideId, divIndex, innerIndex, family) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, fontFamilyButton: family }
                        : innerElement
                  ),
                }
              : element
...
// Update border style
const updateBorderStyleButton = (slideId, divIndex, innerIndex, newBorderStyle) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, borderStyleButton: newBorderStyle }
                        : innerElement
                  ),
                }
              : element
...
// Update Font Weight
const updateButtonWeight = (slideId, divIndex, innerIndex, weight) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, fontWeightButton: weight }
                        : innerElement
                  ),
                }
              : element
...
// Update Rotate
const updateRotateButton = (slideId, divIndex, innerIndex, rotate) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, rotateButton: rotate }
                        : innerElement
                  ),
                }
              : element
...
// Update Opacity
const updateOpacityButton = (slideId, divIndex, innerIndex, opacity) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, opacityButton: opacity }
                        : innerElement
                  ),
                }
              : element
...
// Custom width
const updateCustomWidthButton = (slideId, divIndex, innerIndex, customWidth) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, widthCustomButton: customWidth }
                        : innerElement
                  ),
                }
              : element
...
// Size
const updateFontSizeButton = (slideId, divIndex, innerIndex, newSize) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, fontSizeButton: newSize }
                        : innerElement
                  ),
                }
              : element
...
// Size Tablet
const updateFontSizeButtonTablet = (slideId, divIndex, innerIndex, newSizeTablet) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, fontSizeButtonTablet: newSizeTablet }
                        : innerElement
                  ),
                }
              : element
...
// Size Mobile
const updateFontSizeButtonMobile = (slideId, divIndex, innerIndex, newSizeMobile) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, fontSizeButtonMobile: newSizeMobile }
                        : innerElement
                  ),
                }
              : element
...
// Line height
const updateLineHeightButton = (slideId, divIndex, innerIndex, newLineHeight) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, lineHeightButton: newLineHeight }
                        : innerElement
                  ),
                }
              : element
...
// Letter Spacing
const updateLetterSpacingButton = (slideId, divIndex, innerIndex, newLetterSpacing) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, letterSpacingButton: newLetterSpacing }
                        : innerElement
                  ),
                }
              : element
...
// Duration effect
const updateDurationEffectButton = (slideId, divIndex, innerIndex, newDurationEffect) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, durationEffectButton: newDurationEffect }
                        : innerElement
                  ),
                }
              : element
...
// Delay effect
const updateDelayEffectButton = (slideId, divIndex, innerIndex, newDelayEffect) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, delayEffectButton: newDelayEffect }
                        : innerElement
                  ),
                }
              : element
...
// Update Border color
const updateButtonBackgroundBorderColor = (slideId, divIndex, innerIndex, color) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, backgroundBorderColorButton: color }
                        : innerElement
                  ),
                }
              : element
...
// Width border
const updateButtonBackgroundBorderSize = (slideId, divIndex, innerIndex, newSize) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, backgroundBorderSizeButton: newSize }
                        : innerElement
                  ),
                }
              : element
...
// Border radius
const updateButtonBackgroundBorderRadius = (slideId, divIndex, innerIndex, newRadius) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, backgroundBorderRadiusButton: newRadius }
                        : innerElement
                  ),
                }
              : element
...
const updatenewPaddingButton = (slideId, divIndex, innerIndex, newPaddingtitle) => {
  console.log("Updating padding with:", newPaddingtitle); // Log per debug
...
// Parallax text x
const updateParallaxButton = (slideId, divIndex, innerIndex, newParallaxTitle) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, parallaxButton: newParallaxTitle }
                        : innerElement
                  ),
                }
              : element
...
// Parallax text y
const updateParallaxButtonY = (slideId, divIndex, innerIndex, newParallaxTitleY) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, parallaxButtonY: newParallaxTitleY }
                        : innerElement
                  ),
                }
              : element
...
// Parallax text scale
const updateParallaxButtonScale = (slideId, divIndex, innerIndex, newParallaxTitleScale) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, parallaxButtonScale: newParallaxTitleScale }
                        : innerElement
                  ),
                }
              : element
...
const updateParallaxButtonOpacity = (slideId, divIndex, innerIndex, newParallaxTitleOpacity) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, parallaxButtonOpacity: newParallaxTitleOpacity }
                        : innerElement
                  ),
                }
              : element
...
const updateParallaxButtonDuration = (slideId, divIndex, innerIndex, newParallaxTitleDuration) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, parallaxButtonDuration: newParallaxTitleDuration }
                        : innerElement
                  ),
                }
              : element
...
const updateCustomHeightButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, heightCustomButton: value }
                        : innerElement
                  ),
                }
              : element
...
// Effect Text Split
const updateButtonAnimation = (slideId, divIndex, innerIndex, animation) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, animationButton: animation }
                        : innerElement
                  ),
                }
              : element
...
// Selector link
const updateButtonLink = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
...
// Link Url
const updateLinkUrlButton = (slideId, divIndex, innerIndex, url) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, linkUrlButton: url }
                        : innerElement
                  ),
                }
              : element
...
// Link Target
const updateScrollToIdButton = (slideId, divIndex, innerIndex, id) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, scrollToIdButton: id }
                        : innerElement
                  ),
                }
              : element
...
// Link Target
const updateLinkTargetButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, linkTargetButton: value }
                        : innerElement
                  ),
                }
              : element
...
// Link Rel
const updateLinkRelButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, linkRelButton: value }
                        : innerElement
                  ),
                }
              : element
...
// Enable Desktop
const updateEnableDesktopButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, enableDesktopButton: value }
                        : innerElement
                  ),
                }
              : element
...
// Z index
const updateZindexButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, zIndexButton: value }
                        : innerElement
                  ),
                }
              : element
...
// Enable Tablet
const updateEnableTabletButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, enableTabletButton: value }
                        : innerElement
                  ),
                }
              : element
...
// Enable Mobile
const updateEnableMobileButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, enableMobileButton: value }
                        : innerElement
                  ),
                }
              : element
...
const updateWidthButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, widthButton: value }
                        : innerElement
                  ),
                }
              : element
...
const updateIcoPositionButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, icoPositionButton: value }
                        : innerElement
                  ),
                }
              : element
...
const updateIcoAligItemButton = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, icoAligItemButton: value }
                        : innerElement
                  ),
                }
              : element
  ...
  setAttributes({ slides: updatedSlides });
     ...
     // Update gap icon
const updateGapIcon = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
...
// Update size icon
const updateSizeIcon = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
...
// Update color icon
const updateIconColor = (slideId, divIndex, innerIndex, color) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
...
// Update rotate icon
const updateRotateIcon = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
        ...
        <>
          ...
          <div className="custom-select">
              <TextareaControl
                ...
                onChange={(newButton) =>
                  updateSlideButton(slide.id, elementIndex,buttonIndex, newButton)
                }
            ...
            {buttonDiv.buttonType === 'type1' && buttonDiv.buttonType === 'type2' && (
              <>
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.widthCustomButton}
                ...
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.heightCustomButton}
                    onChange={(value) =>
             ...
             {buttonDiv.buttonType !== 'type1' && buttonDiv.buttonType !== 'type2' && (
              ...
              <SelectControl
                ...
                value={buttonDiv.widthButton}
                onChange={(value) =>
                  updateWidthButton(slide.id, elementIndex, buttonIndex, value)
                }
                options={[
                  {
            ...
            <div className="custom-select">
              <AlignmentControlThree
                value={buttonDiv.buttonAlign}
                onChange={(align) =>
                  updateButtonAlign(slide.id, elementIndex, buttonIndex, align)
                }
              />
            </div>
            <div className="custom-select">
          ...
          ></Button>
            ...
            <button onClick={handleOpenIconModal}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg></button>
              ...
              <SelectControl
                ...
                value={buttonDiv.icoPositionButton}
                onChange={(value) =>
                  updateIcoPositionButton(slide.id, elementIndex,  buttonIndex, value)
                }
                options={[
                  {
            ...
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                value={buttonDiv.icoAligItemButton}
                onChange={(value) =>
                  updateIcoAligItemButton(slide.id, elementIndex, buttonIndex, value)
                }
                options={[
                  {
          ...
          {buttonDiv.buttonType !== 'type1' && buttonDiv.buttonType !== 'type2' && (
            ...
            <div className="custom-select">
              ...
              {device === "desktop" && (
                <RangeControl
                  ...
                  value={buttonDiv.fontSizeButton}
                  onChange={(newSize) =>
                    updateFontSizeButton(slide.id, elementIndex, buttonIndex, newSize)
                  }
                  min={4}
                  max={500}
                  step={1}
              ...
              {device === "tablet" && (
                <RangeControl
                  ...
                  value={buttonDiv.fontSizeButtonTablet}
                  onChange={(newSizeTablet) =>
                    updateFontSizeButtonTablet(slide.id, elementIndex, buttonIndex, newSizeTablet)
                  }
                  min={4}
                  max={500}
                  step={1}
              ...
              {device === "mobile" && (
                <RangeControl
                  ...
                  value={buttonDiv.fontSizeButtonMobile}
                  onChange={(newSizeMobile) =>
                    updateFontSizeButtonMobile(slide.id, elementIndex, buttonIndex, newSizeMobile)
                  }
                  min={4}
                  max={500}
                  step={1}
            ...
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                options={fontOptions}
                onChange={(family) =>
                  updateButtonFamily(slide.id, elementIndex, buttonIndex, family)
                }
              />
            </div>
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                value={buttonDiv.fontWeightButton}
                options={[
                  {
                ...
                onChange={(weight) =>
                  updateButtonWeight(slide.id, elementIndex, buttonIndex, weight)
                }
              />
            </div>
            <div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.lineHeightButton}
                onChange={(newLineHeight) =>
                  updateLineHeightButton(slide.id, elementIndex, buttonIndex, newLineHeight)
                }
                min={0.5}
                max={2.5}
                step={0.1}
            ...
            <div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.letterSpacingButton}
                onChange={(newLetterSpacing) =>
                  updateLetterSpacingButton(slide.id, elementIndex, buttonIndex, newLetterSpacing)
                }
                min={0}
                max={100}
                step={0.5}
            ...
            <div className="custom-select color">
              <ColorOptionsPanel
                ...
                setColorNormal={(color) =>
                  updateSlideButtonColor(slide.id, elementIndex, buttonIndex, color)
                }
            ...
            <div className="custom-select color">
              <ColorOptionsPanel
                ...
                setColorNormal={(color) =>
                  updateSlideButtonBackgroundColor(slide.id, elementIndex, buttonIndex, color)
                }
            ...
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                onChange={(newBorderStyle) =>
                  updateBorderStyleButton(slide.id, elementIndex, buttonIndex, newBorderStyle)
                }
              />
            </div>
              ...
              <>
                ...
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.backgroundBorderSizeButton}
                    onChange={(newSize) =>
              ...
              <>
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.backgroundBorderRadiusButton}
                    onChange={(newRadius) =>
          ...
          >
            <div className="custom-select">
              ...
              <ColorOptionsPanel
                ...
                setColorNormal={(color) =>
                  updateIconColor(slide.id, elementIndex, buttonIndex, color)
                }
                buttonTitle={__("Color", "cocoblocks")}
                buttonIcon={
                  <svg
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.rotateButton}
                onChange={(rotate) =>
                  updateRotateButton(slide.id, elementIndex, buttonIndex, rotate)
                }
                min={0}
                max={360}
                step={1}
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.opacityButton}
                onChange={(opacity) =>
                  updateOpacityButton(slide.id, elementIndex, buttonIndex, opacity)
                }
                min={0.1}
                max={1}
                step={0.1}
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.zIndexButton}
                onChange={(value) =>
                  updateZindexButton(slide.id, elementIndex, buttonIndex, value)
                }
                min={0}
                max={999}
                step={1}
...
<div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.rotateIcon}
                onChange={(value) =>
                  updateRotateIcon(slide.id, elementIndex, buttonIndex, value)
                }
                min={0}
                max={360}
                step={1}
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                value={buttonDiv.animationButton}
                options={[
                  { label: "None", value: "none" },
                  { label: "Fade In", value: "fade-in-button-inner" },
                  { label: "Fade In Left", value: "fade-in-left-button-inner" },
                  { label: "Fade In Right", value: "fade-in-right-button-inner" },
                  { label: "Fade In Top", value: "fade-in-top-button-inner" },
                  { label: "Fade In Bottom", value: "fade-in-bottom-button-inner" },
                  { label: "Slide In Left", value: "slide-in-left-button-inner" },
                  { label: "Slide In Right", value: "slide-in-right-button-inner" },
                  { label: "Slide In Top", value: "slide-in-top-button-inner" },
                  { label: "Slide In Bottom", value: "slide-in-bottom-button-inner" },
                  { label: "Zoom In", value: "zoom-in-button-inner" },
                  { label: "Zoom In Left", value: "zoom-in-left-button-inner" },
                  { label: "Zoom In Right", value: "zoom-in-right-button-inner" },
                  { label: "Zoom In Top", value: "zoom-in-top-button-inner" },
                  { label: "Zoom In Bottom", value: "zoom-in-bottom-button-inner" },
                  { label: "Rotate In Left", value: "rotate-in-left-button-inner" },
                  { label: "Rotate In Right", value: "rotate-in-right-button-inner" },
                  { label: "Rotate In Top", value: "rotate-in-top-button-inner" },
                  { label: "Rotate In Bottom", value: "rotate-in-bottom-button-inner" },
                  { label: "Rotate Continuos", value: "rotate-continuous-button-inner" },
                  { label: "Bounce in", value: "bounce-effect-button-inner" },
                  { label: "Bounce in Left", value: "bounce-left-effect-button-inner" },
                  { label: "Bounce in Right", value: "bounce-right-effect-button-inner" },
                  { label: "Bounce in Top", value: "bounce-top-effect-button-inner" },
                  { label: "Bounce in Bottom", value: "bounce-bottom-effect-button-inner" },
                  { label: "Wiggle", value: "wiggle-button-inner" },
                  { label: "Flip", value: "flip-button-inner" },
                  { label: "Swing", value: "swing-button-inner" },
                  { label: "Rubber band", value: "rubber-band-button-inner" },
                  { label: "Stretch", value: "stretch-button-inner" },
                ]}
                onChange={(animation) =>
                  updateButtonAnimation(slide.id, elementIndex, buttonIndex, animation)
                }
              />
            </div>
            {buttonDiv.animationButton !== "none" && (
              <>
                  <div className="custom-select">
                    <RangeControl
                      label={
                      ...
                      value={buttonDiv.durationEffectButton}
              ...
              <div className="custom-select">
                <RangeControl
                  ...
                  value={buttonDiv.delayEffectButton}
                  onChange={(newDelayEffect) =>
                    updateDelayEffectButton(slide.id, elementIndex, buttonIndex, newDelayEffect)
                  }
                  min={0}
                  max={10}
                  step={0.1}
            ...
            {[
              ...
              "swing-button",
              "rubber-band-button",
            ].includes(buttonDiv.animationButton) && (
              <div className="custom-select select-control-label-right">
                <SelectControl
                  label={
                    <>
                  ...
                  value={buttonDiv.iterationButton}
                  options={[
                    { label: "Forwards", value: "forwards" },
                    { label: "Infinite", value: "infinite" },
                  ]}
                  onChange={(value) =>
                    updateInterationButton(slide.id, elementIndex, buttonIndex, value)
                  }
                />
              </div>
            )}
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            ...
            <div className="custom-select">
              <RangeControl
                ...
                value={buttonDiv.delayTransition}
                onChange={(value) =>
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                onChange={(value) =>
                  updateIconAnimation(slide.id, elementIndex, buttonIndex, value)
                }
                options={[
                  {
                    label: __("None", "cocoblocks"),
            ...
            <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.iconAnimationDuration}
                    onChange={(value) =>
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                onChange={(value) =>
                  updateButtonLink(slide.id, elementIndex, buttonIndex, value)
                }
              />
            </div>
            {buttonDiv.buttonLink === "link" && (
              <>
                <div className="custom-select select-text-control">
                  <TextControl
                    ...
                    value={buttonDiv.linkUrlButton}
                    onChange={(value) =>
                      updateLinkUrlButton(slide.id, elementIndex, buttonIndex, value)
                    }
                  />
                </div>
                <div className="custom-select select-control-label-right">
                  <SelectControl
                    ...
                    value={buttonDiv.linkTargetButton}
                    options={[
                      { label: "Same Window", value: "_self" },
                      { label: "New Window", value: "_blank" },
                    ]}
                    onChange={(value) =>
                      updateLinkTargetButton(slide.id, elementIndex, buttonIndex, value)
                    }
                  />
                </div>
                <div className="custom-select select-control-label-right">
                  <SelectControl
                    ...
                    value={buttonDiv.linkRelButton}
                    options={[
                      { label: "Follow Link", value: "follow" },
                      { label: "No Follow", value: "nofollow" },
                    ]}
                    onChange={(value) =>
                      updateLinkRelButton(slide.id, elementIndex, buttonIndex, value)
                    }
                  />
                </div>
              </>
            )}
            {buttonDiv.buttonLink === "scroll-to-id" && (
              <div className="custom-select select-text-control">
                <TextControl
                  label={
                    <>
                  ...
                  value={buttonDiv.scrollToIdButton}
                  onChange={(value) =>
                    updateScrollToIdButton(slide.id, elementIndex, buttonIndex, value)
                  }
                />
              </div>
            )}
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select">
              <ToggleControl
                ...
                checked={buttonDiv.enableDesktopButton}
                onChange={(value) =>
                  updateEnableDesktopButton(slide.id, elementIndex, buttonIndex, value)
                }
              />
            </div>
            <div className="custom-select">
              <ToggleControl
                ...
                checked={buttonDiv.enableTabletButton}
                onChange={(value) =>
                  updateEnableTabletButton(slide.id, elementIndex, buttonIndex, value)
                }
              />
            </div>
            <div className="custom-select">
              <ToggleControl
                ...
                checked={buttonDiv.enableMobileButton}
                onChange={(value) =>
                  updateEnableMobileButton(slide.id, elementIndex, buttonIndex, value)
                }
              />
            </div>
          </div>
              ...
              <div className="content-section-panel" style={{ padding: "0" }}>
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.parallaxButton}
                ...
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.parallaxButtonY}
                ...
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.parallaxButtonScale}
                ...
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.parallaxButtonOpacity}
                ...
                <div className="custom-select">
                  <RangeControl
                    ...
                    value={buttonDiv.parallaxButtonDuration}
...
export default ButtonControlsBlock;
