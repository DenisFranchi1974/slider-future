      ...
      {activeSection === "animation" && (
        <>
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
              ...
              <SelectControl
                ...
                options={[
                  ...
                  { label: "Zoom In Top", value: "zoom-in-top-title-div" },
                  {
                    ...
                    value: "zoom-in-bottom-title-div",
                  },
                  {
                    label: "Rotate In Left",
                    value: "rotate-in-left-title-div",
                  },
                  {
                    label: "Rotate In Right",
                    value: "rotate-in-right-title-div",
                  },
                  { label: "Rotate In Top", value: "rotate-in-top-title-div" },
                  {
                    label: "Rotate In Bottom",
                    value: "rotate-in-bottom-title-div",
                  },
                  {
                    label: "Rotate Continuos",
                    value: "rotate-continuous-title-div",
                  },
                  { label: "Bounce in", value: "bounce-effect-title-div" },
                  {
                    label: "Bounce in Left",
                    value: "bounce-left-effect-title-div",
                  },
                  {
                    label: "Bounce in Right",
                    value: "bounce-right-effect-title-div",
                  },
                  {
                    label: "Bounce in Top",
                    value: "bounce-top-effect-title-div",
                  },
                  {
                    label: "Bounce in Bottom",
                    value: "bounce-bottom-effect-title-div",
                  },
                  ...
                  { label: "Implode", value: "implode-title-div" },
                  {
                    ...
                    value: "letters-fly-in-from-left-div",
                  },
                  {
                    label: "Letters Fly In From Right",
                    value: "letters-fly-in-from-right-div",
                  },
                  {
                    label: "Letters Fly In From Top",
                    value: "letters-fly-in-from-top-div",
                  },
                  {
                    label: "Letters Fly In From Bottom",
                    value: "letters-fly-in-from-bottom-div",
                  },
                  {
                    label: "Letter Flip From Top",
                    value: "letter-flip-from-top-div",
                  },
                  {
                    label: "Letter Flip From Bottom",
                    value: "letter-flip-from-bottom-div",
                  },
                  {
                    label: "Letter Flip Cycle",
                    value: "letter-flip-cycle-div",
                  },
                  {
                    label: "Gradient Animation",
                    value: "gradient-animation-title-div",
                  },
                  { label: "Text Shadow", value: "text-shadow-title-div" },
                  {
                    label: "Text Shadow Light",
                    value: "text-shadow-light-title-div",
                  },
                  {
                    label: "Text Shadow Heavy",
                    value: "text-shadow-heavy-title-div",
                  },
            ...
            {textDiv.animation !== "none" && (
              <>
                {![
                  " ",
                  "typing-effect",
                  "text-shadow-title-div",
                  "text-shadow-light-title-div",
                  "text-shadow-heavy-title-div",
                  "text-neon-title-div",
            ...
            {(textDiv.animation === "explode-title-div" ||
              textDiv.animation === "implode-title-div") && (
              <div className="custom-select select-control-label-right">
                <SelectControl
                  label={
                    <>
            ...
            {["gradient-animation-title-div"].includes(textDiv.animation) && (
              <>
                <div className="custom-select color">
                  <ColorOptionsPanel
                ...
                <div className="custom-select select-control-label-right">
                  <SelectControl
                    ...
                    options={[
                      ...
                      {
                        label: "Bounce X",
                        value: "bounceUnderlineHorizontalTitleDiv",
                      },
                    ]}
                    onChange={(value) =>
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                onChange={(value) =>
                  updateTextLink(slide.id, elementIndex, textIndex, value)
                }
              />
            </div>
            {textDiv.textLink === "link" && (
              <>
                <div className="custom-select select-text-control">
                  <TextControl
                    ...
                    onChange={(value) =>
                      updateLinkUrl(slide.id, elementIndex, textIndex, value)
                    }
                  />
                </div>
                <div className="custom-select select-control-label-right">
                  <SelectControl
                    ...
                    onChange={(value) =>
                      updateLinkTarget(slide.id, elementIndex, textIndex, value)
                    }
                  />
                </div>
                <div className="custom-select select-control-label-right">
                  <SelectControl
                    ...
                    onChange={(value) =>
                      updateLinkRel(slide.id, elementIndex, textIndex, value)
                    }
                  />
                </div>
              </>
            )}
            {textDiv.textLink === "scroll-to-id" && (
              <div className="custom-select select-text-control">
                <TextControl
                  label={
                    <>
                  ...
                  onChange={(value) =>
                    updateScrollToId(slide.id, elementIndex, textIndex, value)
                  }
                />
              </div>
            )}
