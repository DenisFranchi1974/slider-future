...
const ImageComponent = ({ element, index}) => {
    const getImageStyle = () => {
        let style = {
          ...
          borderWidth:
            element.backgroundBorderSizeImage + "px",
          borderRadius:
          ...
          "--transition-hover-image": element.durationEffectHoverImage + 's' || "0.3",
          "--translate-hover-image": element.translateEffectHoverImage +'px' || "-10",
      ...
      return (
        <div
          style={{
            ...
            "--duration-effect-moving-image": element.durationEffectImageMoving + "s",
            "--translate-effect-moving-image": element.translateEffectImageMoving + "px",
