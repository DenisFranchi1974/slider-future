...
const TextComponent = ({ element, index }) => {
    ...
    const stylesSpan = {
      ...
      const TypewriterEffect = ({ text, speed = element.speedEffect, pauseDuration = element.pauseEffect }) => {
    ...
    <div
        ...
        "--animation-decoration-from" : element.underlineAnimationFrom + "%" || "0",
        ...
        "--animation-decoration-transition" : element.underlineAnimationTransition + "s" || "0.5",
