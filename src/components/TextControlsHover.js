...
const TextControlsHover = ({
  ...
  const showTranslateRangeControl = [
    "hover-effect-2", // Translate Y
    "hover-effect-5", // Translate X
  ].includes(element.animationHover);
        ...
        <div className="custom-select select-control-label-right">
          <SelectControl
            ...
            options={[
              ...
              { label: "Scale", value: "hover-effect-1" },
              { label: "Translate Y", value: "hover-effect-2" },
              { label: "Translate X", value: "hover-effect-5" },
              { label: "Shadow", value: "hover-effect-3-" },
              { label: "Shadow Two", value: "hover-effect-3" },
              { label: "Shadow Three", value: "hover-effect-4" },
              { label: "Filter", value: "hover-effect-6" },
              { label: "Light", value: "hover-light-effect" },
            ]}
            onChange={(animation) =>
...
export default TextControlsHover;
