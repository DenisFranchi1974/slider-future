...
const IconControls = ({
  ...
  const  updateSlideBackgroundColor = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
  ...
  const updateEnableMobileTitle = (slideId, index, value) => {
    ...
    // Z index
    const updateZindexIcon = (slideId, index, value) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
  ...
  return (
    <div className="custom-block-added">
      ...
      <div className="title-block-added">
        ...
        {element.icon && <i className={element.icon} style={{fontSize:'18px',color:'var(--light-color)',marginRight:'3px'}}></i>}
            ...
            <div className="custom-select color">
              <ColorOptionsPanel
                ...
                setColorNormal={(value) =>
                  updateSlideBackgroundColor(slide.id, elementIndex, value)
                }
          ...
          <div className="content-section-panel" style={{ padding: "0" }}>
            <div className="custom-select">
              <RangeControl
                ...
                value={element.zIndexIcon}
                onChange={(value) =>
                  updateZindexIcon(slide.id, elementIndex, value)
                }
                min={0}
                max={999}
                step={1}
