  ...
  return (
        ...
        <div className="content-section-panel" style={{ padding: "0" }}>
          <div className="custom-select color">
              <ColorOptionsPanel
                colorNormal={iconDiv.colorShadow}
                setColorNormal={(value) =>
                    updateColorShadow(slide.id, elementIndex,iconIndex, value)
                }
            ...
            <div className="custom-select">
                <RangeControl
                    ...
                    value={iconDiv.boxShadowX}
                    onChange={(value) =>
                        updateBoxShadowX(slide.id, elementIndex,iconIndex, value)
                    }
                    min={-100}
                    max={100}
                    step={1}
            ...
            <div className="custom-select">
                ...
                value={iconDiv.boxShadowY}
                onChange={(value) =>
                    updateBoxShadowY(slide.id, elementIndex,iconIndex, value)
                }
                min={-100}
                max={100}
                step={1}
           ...
           <div className="custom-select">
                ...
                value={iconDiv.boxShadowBlur}
                onChange={(value) =>
                    updateBoxShadowBlur(slide.id, elementIndex,iconIndex, value)
                }
                min={0}
                max={100}
                step={1}
                ...
                value={iconDiv.boxShadowSpread}
                onChange={(value) =>
                    updateBoxShadowSpread(slide.id, elementIndex,iconIndex, value)
                }
                min={-100}
                max={100}
                step={1}
...
export default BoxShadowIconBlock;
