     ...
     />
      ...
      >
        <h2 className="title-custom-panel">{__("Animations", "slider-future")}</h2>
          {(titlePostEffect !== 'none' && titlePostEffect !== 'animation-pro') && (
...
<div
      ...
      <div className="content-section-panel" style={{ padding: "0" }}>
          ...
          />
           {titlePostEffectHover === "animation-pro" && (
      <ProNotice 
        radiusOneProNotice = '0'
        radiusTwoProNotice = '0'
      />
          )}
          {(titlePostEffectHover !== 'none' && titlePostEffectHover !== 'animation-pro') && (
        <>
        <CustomRangeControl
          label={
            <>
