...
const ButtonControlsHover = ({
  ...
  // Update Button color
  const updateSlideButtonColorHover = (slideId, index, color) => {
        ...
        ? {
            ...
            elements: slide.elements.map((element, i) =>
              element.type === "button" && i === index
                ? { ...element, buttonColorHover: color }
                : element
            ),
          }
        : slide
    ...
    // Update Icon color
    const updateSlideIconColorHover = (slideId, index, color) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
    ...
    // Update Icon animation hover
    const updateAnimationHoverIcon = (slideId, index, value) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
              elements: slide.elements.map((element, i) =>
                element.type === "button" && i === index
                  ? { ...element, animationHoverIcon: value }
                  : element
              ),
            }
          : slide
     ...
     // Update Icon animation hover transition
     const  updateDurationEffectHoverIcon = (slideId, index, value) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
              elements: slide.elements.map((element, i) =>
                element.type === "button" && i === index
                  ? { ...element, durationEffectHoverIcon: value }
                  : element
              ),
            }
          : slide
    ...
    // Update Icon animation hover translate
    const  updateTranslateEffectHoverIcon = (slideId, index, value) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
              elements: slide.elements.map((element, i) =>
                element.type === "button" && i === index
                  ? { ...element, translateEffectHoverIcon: value }
                  : element
              ),
            }
          : slide
    ...
    const updateSlideButtonBackgroundColorHover = (slideId, index, color) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
              elements: slide.elements.map((element, i) =>
                element.type === "button" && i === index
                  ? { ...element, buttonBackgroundColorHover: color }
                  : element
              ),
            }
          : slide
  ...
  const updateRotateHover = (slideId, index, rotate) => {
    ...
    // Update Rotate Icon
    const updateRotateIconHover = (slideId, index, rotate) => {
      const updatedSlides = slides.map((slide) =>
        slide.id === slideId
          ? {
              ...slide,
              elements: slide.elements.map((element, i) =>
                element.type === "button" && i === index
                  ? { ...element, rotateIconHover: rotate }
                  : element
              ),
            }
          : slide
  ...
  // Show icon in hover
  const updateIconShowHover = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
  ...
  const updateIconHideShowHover = (slideId, index, value) => {
    const updatedSlides = slides.map((slide) =>
      slide.id === slideId
        ? {
            ...slide,
            elements: slide.elements.map((element, i) =>
              element.type === "button" && i === index
                ? { ...element, iconHideShowHover: value }
                : element
            ),
          }
        : slide
    ...
    <div className="custom-block-added">
      ...
      <div className="content-section-panel" style={{ padding: "0" }}>
        <div className="custom-select color">
          <ColorOptionsPanel
            ...
            setColorNormal={(color) =>
              updateSlideButtonColorHover(slide.id, elementIndex, color)
            }
        ...
        <div className="custom-select color">
          <ColorOptionsPanel
            ...
            setColorNormal={(color) =>
              updateSlideButtonBackgroundColorHover(slide.id, elementIndex, color)
            }
      ...
      <div className="custom-select color">
          <ColorOptionsPanel
            ...
            setColorNormal={(color) =>
              updateSlideIconColorHover(slide.id, elementIndex, color)
            }
            buttonTitle={__("Color", "cocoblocks")}
            buttonIcon={
              <svg
      ...
      <div className="custom-select">
          <RangeControl
            ...
            value={element.rotateIconHover}
            onChange={(rotate) =>
              updateRotateIconHover(slide.id, elementIndex, rotate)
            }
            min={0}
            max={360}
            step={1}
        ...
        <div className="custom-select select-control-label-right">
          <SelectControl
            ...
            onChange={(value) =>
              updateAnimationHoverIcon(slide.id, elementIndex, value)
            }
          />
        </div>
          ...
          <>
            <div className="custom-select">
              <RangeControl
                ...
                value={element.durationEffectHoverIcon}
                onChange={(value) =>
            ...
            {(element.animationHoverIcon === "hover-effect-2-icon-button" || element.animationHoverIcon === "hover-effect-5-icon-button") && (
              ...
              <div className="custom-select">
                <RangeControl
                  ...
                  value={element.translateEffectHoverIcon}
                  onChange={(value) =>
        ...
        <div className="custom-select select-control-label-right">
          <SelectControl
            ...
            onChange={(value) =>
              updateIconShowHover(slide.id, elementIndex, value)
            }
          />
        </div>
        {element.iconShowHover === 'icon-show-hover' && (
           ...
           <SelectControl
             ...
             onChange={(value) =>
               updateIconHideShowHover(slide.id, elementIndex, value)
             }
           />
         </div>
          )}
...
export default ButtonControlsHover;
