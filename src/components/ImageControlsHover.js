            ...
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                onChange={(newBorderStyle) =>
                  updateBorderStyleHoverImage(slide.id, elementIndex, newBorderStyle)
                }
              />
            </div>
          ...
          <div className="content-title-custom-panel intermedy">
             ...
             <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                options={[
                  ...
                  { label: "Moving background X", value: "moving-background-hover" },
                  { label: "Moving background Y", value: "moving-background-y-hover" },
                ]}
                onChange={(value) =>
            ...
            <div className="custom-select select-control-label-right">
              <SelectControl
                ...
                options={[
                  ...
                  { label: "Shadow Three", value: "hover-effect-4-image" },
                ]}
                onChange={(animation) =>
            ...
            <div className="custom-select color">
              <ColorOptionsPanel
                ...
                setColorNormal={(color) =>
                  updateSlideEffectColorHoverImage(slide.id, elementIndex, color)
                }
