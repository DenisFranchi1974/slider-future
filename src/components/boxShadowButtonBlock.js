...
const BoxShadowControlButtonBlock = ({ 
  slide,
  slides,
  element,
  buttonDiv,
  ...
  // Color Shadow
const updateColorShadow = (slideId, divIndex, innerIndex, value) => {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, colorShadow: value }
                        : innerElement
                  ),
                }
              : element
...
// Box ShadowX 
const updateBoxShadowX = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
...
// Box ShadowY 
const updateBoxShadowY = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
...
// Box Shadow Blur
const updateBoxShadowBlur = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, boxShadowBlur: value }
                        : innerElement
                  ),
                }
              : element
...
// Box Shadow Spread
const updateBoxShadowSpread = (slideId, divIndex, innerIndex, value) => {
  const updatedSlides = slides.map((slide) =>
    slide.id === slideId
      ? {
          ...slide,
            ...
            element.type === "div" && i === divIndex
              ? {
                  ...
                  innerElements: element.innerElements.map(
                    (innerElement, eIndex) =>
                      eIndex === innerIndex && innerElement.type === "button"
                        ? { ...innerElement, boxShadowSpread: value }
                        : innerElement
                  ),
                }
              : element
  ...
  return (
        ...
        <div className="content-section-panel" style={{ padding: "0" }}>
          <div className="custom-select color">
              <ColorOptionsPanel
                colorNormal={buttonDiv.colorShadow}
                setColorNormal={(value) =>
                    updateColorShadow(slide.id, elementIndex, buttonIndex, value)
                }
            ...
            <div className="custom-select">
                <RangeControl
                    ...
                    value={buttonDiv.boxShadowX}
                    onChange={(value) =>
                        updateBoxShadowX(slide.id, elementIndex, buttonIndex, value)
                    }
                    min={-100}
                    max={100}
                    step={1}
            ...
            <div className="custom-select">
                ...
                value={buttonDiv.boxShadowY}
                onChange={(value) =>
                    updateBoxShadowY(slide.id, elementIndex, buttonIndex, value)
                }
                min={-100}
                max={100}
                step={1}
           ...
           <div className="custom-select">
                ...
                value={buttonDiv.boxShadowBlur}
                onChange={(value) =>
                    updateBoxShadowBlur(slide.id, elementIndex, buttonIndex, value)
                }
                min={0}
                max={100}
                step={1}
                ...
                value={buttonDiv.boxShadowSpread}
                onChange={(value) =>
                    updateBoxShadowSpread(slide.id, elementIndex, buttonIndex, value)
                }
                min={-100}
                max={100}
                step={1}
...
export default BoxShadowControlButtonBlock;
