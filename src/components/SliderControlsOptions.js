...
const SliderControlsOptions = ({ attributes, setAttributes }) => {
	...
	// Section slider
    const [activeSectionOptions, setActiveSectionSliderOptions] = useState('background');

	return (
		<>
		    <div className='content-subdescription-section-slider'><h2>{__('Slide Options')}</h2></div>
            <SectionSliderSelectorOptions onSectionChange={setActiveSectionSliderOptions} />
