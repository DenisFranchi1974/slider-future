          ...
          if (!element.classList.contains(animationClass)) {
            ...
            setTimeout(() => {
              ...
              spans.forEach((span, index) => {
                ...
                if (animationClass === 'letters-fly-in-from-left' || animationClass === 'letters-fly-in-from-right' || animationClass === 'letters-fly-in-from-top' || animationClass === 'letters-fly-in-from-bottom') {
                  span.style.setProperty('--letter-index', index + 1);
                } else if (animationClass === 'letter-flip-from-top' || animationClass === 'letter-flip-from-bottom' || animationClass === 'letter-flip-cycle') {
                  span.style.setProperty('--letter-index', index + 1);
                }
              });
  ...
  submenuToggles.forEach(button => {
    ...
    button.addEventListener('click', () => {
      ...
      if (subMenu.style.display === 'block') {
        // Chiudi il sub-menu
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(subMenu, {
          height: 0,
          opacity: 0,
          duration: 0.5,
          ease: 'power2.inOut',
        ...
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.fromTo(subMenu, {
          height: 0,
          opacity: 0
        }, {
          height: 'auto',
